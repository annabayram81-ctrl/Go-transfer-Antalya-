import { placesBySlug, routes, whatsappPhone } from "./route-data.js?v=20260728-pwa-69";
...
const localizedDestination =
  route.slug === "belek" ? "Belek" : route.slug === "lara" ? "Lara" : route.slug === "alanya" ? "Alanya" : route.slug === "side" ? "Side" : route.slug === "konyaalti" ? "Konyaaltı" : route.destination;
